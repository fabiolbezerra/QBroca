...
public class GenericDAO<T> implements InterfaceDAO<T> {
    ...
    public GenericDAO() {
        //Ao criar a instância do GenericDAO uma EntityManager é criada
        this.entityManager = FabricaEntityManager.criarEntityManager();
    }

    public GenericDAO(String persistenceUnit) {
        //Ao criar a instância do GenericDAO uma EntityManagerFactory é criada
        this.entityManager = FabricaEntityManager.criarEntityManager(persistenceUnit);
    }
